...
void initCityList() {
  ...
  cityList["呼和浩特"] = CityInfo(cityName: "呼和浩特", x: 9, y: 3);
  cityList["敦煌"] = CityInfo(cityName: "敦煌", x: 4, y: 3);
  ...
  cityList["兰州"] = CityInfo(cityName: "兰州", x: 7, y: 6);
  cityList["西宁"] = CityInfo(cityName: "西宁", x: 6, y: 5);
  cityList["可可西里"] = CityInfo(cityName: "可可西里", x: 4, y: 5);
  cityList["阿里地区"] = CityInfo(cityName: "阿里地区", x: 1, y: 5);
  ...
  cityList["西安"] = CityInfo(cityName: "西安", x: 9, y: 7);
  cityList["天水"] = CityInfo(cityName: "天水", x: 8, y: 7);
  ...
  cityList["南昌"] = CityInfo(cityName: "南昌", x: 11, y: 8);
  cityList["长沙"] = CityInfo(cityName: "长沙", x: 10, y: 9);
  ...
  cityList["海口"] = CityInfo(cityName: "海口", x: 9, y: 13);
}
